...
export default function TrackMap({ progressPercent = 0, color = "#E10600" }) {
  // Simple Monza layout SVG path representation
  ...
  return (
    <div className="glass p-6 rounded-xl flex flex-col items-center justify-center relative w-full h-full min-h-[250px] overflow-hidden group">
      <div className="absolute top-4 left-6 z-10 w-full">
        <h3 className="text-lg font-bold tracking-wider text-gray-200 uppercase">Track Map</h3>
        <p className="text-xs text-gray-400 font-mono tracking-widest mt-0.5">AUTODROMO NAZIONALE MONZA</p>
      </div>
